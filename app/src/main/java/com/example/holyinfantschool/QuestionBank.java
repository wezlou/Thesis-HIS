...
public class QuestionBank {
    ...
    public static List<Question> getQuestions() {
        ...
        questions.add(makeQuestion(2, "What color is the banana?", R.drawable.redapple, R.drawable.btnmango));
        questions.add(makeQuestion(3, "What color are the grapes?", R.drawable.grapes, R.drawable.purplebtn));
        questions.add(makeQuestion(4, "What color is the orange?", R.drawable.redapple, R.drawable.orangebtn));
        questions.add(makeQuestion(5, "What color is the watermelon?", R.drawable.redapple, R.drawable.img_66));
        questions.add(makeQuestion(6, "What color is the blueberry?", R.drawable.redapple, R.drawable.img_38));
        questions.add(makeQuestion(7, "What color is the lemon?", R.drawable.redapple, R.drawable.btnmango));
        questions.add(makeQuestion(8, "What color is the strawberry?", R.drawable.redapple, R.drawable.img_34));
        questions.add(makeQuestion(9, "What color is the pear?", R.drawable.redapple, R.drawable.img_66));
        questions.add(makeQuestion(10, "What color is the eggplant?", R.drawable.redapple, R.drawable.purplebtn));
        questions.add(makeQuestion(11, "What color is the cherry?", R.drawable.redapple, R.drawable.img_34));
        questions.add(makeQuestion(12, "What color is the mango?", R.drawable.mango, R.drawable.btnmango));
        questions.add(makeQuestion(13, "What color is the coconut?", R.drawable.redapple, R.drawable.brownbtn));
        questions.add(makeQuestion(14, "What color is the kiwi?", R.drawable.redapple, R.drawable.img_66));
        questions.add(makeQuestion(15, "What color is the dragon fruit?", R.drawable.redapple, R.drawable.img_33));
