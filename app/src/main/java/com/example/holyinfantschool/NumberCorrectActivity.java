...
public class NumberCorrectActivity extends AppCompatActivity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_number_correct);
        ...
        if (sourceActivity.equals("Number1Activity")) {
            b2Image.setImageResource(R.drawable.f4); //kani e change
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                Intent intent;
                if (sourceActivity.equals("Number1Activity")) {
                    intent = new Intent(NumberCorrectActivity.this, NumberSplashActivity.class);
                } else if (sourceActivity.equals("Number2Activity")) {
                    intent = new Intent(NumberCorrectActivity.this, NumberSplashActivity.class);
                } else {
                    intent = new Intent(NumberCorrectActivity.this, NumberTotalSplash.class);
                }
